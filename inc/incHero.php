...
<header id="top" class="relative">
  ...
  <div class="md:hidden relative bg-beigelight px-6 pt-24 pb-12 min-h-screen flex flex-col justify-center overflow-hidden">
    ...
    <div class="relative flex flex-col items-center gap-8">
      <img src="<?php echo esc_url($img . 'hero-mobile-photo.webp'); ?>" alt="" class="w-full max-w-[322px] aspect-[322/410] object-cover shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)]">
  ...
  <div class="hidden md:flex relative min-h-screen items-center overflow-hidden">
    <img src="<?php echo esc_url($img . 'hero-visual.webp'); ?>" alt="" class="absolute inset-0 w-full h-full object-cover object-[70%_40%]">
