    ...
    <div class="w-full flex flex-col lg:flex-row items-start gap-10 lg:gap-10">
      <div class="flex-1 grid grid-cols-[auto_1fr] gap-x-4 md:gap-x-6 gap-y-3 md:gap-y-0 items-center [grid-template-areas:'photo_name'_'bio_bio'] md:[grid-template-areas:'photo_name'_'photo_bio']">
        ...
        <div class="[grid-area:name] flex flex-col gap-1 self-center md:self-auto">
          ...
          <p class="font-roboto text-xs text-brand tracking-wide">Hideki Koreeda</p>
        </div>
        <div class="[grid-area:bio] font-yu text-sm text-body leading-[1.8]">
          <p>京都生まれ、京都育ち。</p>
          <p>東証一部上場企業にて人事部長を務め、</p>
          <p>2,000名以上の社員を採用した。</p>
          <p>引退後は複数の企業の経営コンサルを務め、</p>
          <p>人事制度や経営改革をおこなっている。</p>
        </div>
      </div>
      ...
      <div class="flex-1 grid grid-cols-[auto_1fr] gap-x-4 md:gap-x-6 gap-y-3 md:gap-y-0 items-center [grid-template-areas:'photo_name'_'bio_bio'] md:[grid-template-areas:'photo_name'_'photo_bio']">
        ...
        <div class="[grid-area:name] flex flex-col gap-1 self-center md:self-auto">
          ...
          <p class="font-serif text-lg md:text-2xl text-ink tracking-wide">山内 綾</p>
          <p class="font-roboto text-xs text-brand tracking-wide">Aya Yamauchi</p>
        </div>
        <p class="[grid-area:bio] font-yu text-sm text-body leading-[1.8]">神戸生まれ神戸育ち。京都の大学を出たあと、東証一部上場企業にて採用担当を務めた。その後はフリーランス人事として様々な業界・職種の採用面接をおこない、8,000名以上の学生と面接。また、国家資格キャリアコンサルタントとして複数の大学でキャリアアドバイザーを務めた。</p>
      </div>
    </div>
  </div>
</section>
